    ...
    <section class="section">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Job Seekers List</h5>
                        <div class="mt-3">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('applied.resume.download', $appliedJob->resume) }}" class="btn btn-primary" target="_blank">Download Resume</a>

                                            <form action="{{ route('apply.job.destroy', $appliedJob->id) }}" method="POST"
