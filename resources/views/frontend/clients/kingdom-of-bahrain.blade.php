...
@section('title', 'Kingdom Of Bahrain')
...
<main class="main">
    <section class="section-box">
        <div class="breacrumb-cover bg-img-about">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <h2 class="mb-10">Kingdom Of Bahrain</h2>
                        <p class="font-lg color-text-paragraph-2">Get the latest top recruiters</p>
                    </div>
    ...
    <section class="section-box mt-50">
        <div class="container">
            <div class="text-start">
                <h2 class="section-title mb-10 wow animate__animated animate__fadeInUp">Hospitality / Retail / FMCG</h2>
    ...
    <section class="section-box mt-50">
        <div class="container">
            <div class="text-start">
                <h2 class="section-title mb-10 wow animate__animated animate__fadeInUp">Manufacturing / Trading / IT / Factories / Recruitment</h2>
                <p class="font-lg color-text-paragraph-2 wow animate__animated animate__fadeInUp">Discover your next career move, freelance gig, or internship</p>
            </div>
        </div>
        <div class="container">
