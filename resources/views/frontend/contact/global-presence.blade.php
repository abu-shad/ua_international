        ...
        <div class="post-loop-grid">
            <div class="container">
                <div class="text-center">
                    ...
                    <p class="font-sm color-text-paragraph w-lg-50 mx-auto wow animate__animated animate__fadeInUp">With a strong global presence, our offices span across multiple regions, ensuring we are always close to our clients. Our strategically located offices provide local expertise combined with global insights, enabling us to deliver the best solutions wherever you are in the world.</p>
                </div>
            </div>
        </div>
    </section>
