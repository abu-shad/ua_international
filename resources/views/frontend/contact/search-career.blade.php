        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content apply-job-form">
                ...
                <div class="modal-body pl-30 pr-30 pt-50">
                    ...
                    <form class="login-register text-start mt-20 pb-30" action="{{ route('create.career.detail') }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf <!-- CSRF token for security -->
                        <input class="form-control" id="modal_job_id" type="hidden" name="career_id" required>

                        <div class="form-group">
                            <label class="form-label" for="fullname">Full Name *</label>
                            <input class="form-control @error('fullname') is-invalid @enderror" id="fullname"
                                type="text" name="fullname" placeholder="Steven Job" value="{{ old('fullname') }}"
                                required>
                            @error('fullname')
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('email') is-invalid @enderror" id="email" type="email"
                                name="email" placeholder="stevenjob@gmail.com" value="{{ old('email') }}" required>
                            @error('email')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('phone') is-invalid @enderror" id="phone" type="text"
                                name="phone" placeholder="(+01) 234 567 89" value="{{ old('phone') }}" required>
                            @error('phone')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                placeholder="Your description..." required>{{ old('description') }}</textarea>
                            @error('description')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="text-muted text-center">Do you need support? <a
                                href="{{ route('help.create') }}">Contact Us</a></div>
                    </form>
                </div>
            </div>
        </div>
                ...
                <div class="banner-hero banner-single banner-single-bg">
                    <div class="block-banner text-center">
                        ...
                        <div class="font-sm color-text-paragraph-2 mt-10 wow animate__animated animate__fadeInUp"
                            data-wow-delay=".1s">we believe in fostering a culture of growth, innovation, and excellence.<br class="d-none d-xl-block">we offer a dynamic environment where you can thrive.</div>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row flex-row-reverse">
                    <div class="col-lg-9 col-md-12 col-sm-12 col-12 float-right">
                        ...
                        <div class="row display-list">
                            @foreach ($jobs as $job)
                                <div class="col-xl-12 col-12  jobs">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="card-grid-2-image-left">
                                                    ...
                                                    <div class="right-info"><a class="name-job"
                                                            ...
                                                            class="location-small">{{ $job->location ?? 'N/A' }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-2-bottom mt-20">
                                                <div class="row">
                                                    <div class="col-lg-7 col-7"><span
                                                            class="text-muted">{{ $job->salary_min ?? 'N/A' }} -
                                                            {{ $job->salary_max ?? 'N/A' }}</span></div>
                                ...
                                <div class="filter-block mb-30">
                                    <div class="form-group ">
                                        <select id="job-select" class="form-control form-icons">
                                            ...
                                            <option value="{{ route('career.search', $industry->id)}}"><a href="{{ route('career.search', $industry->id) }}">{{ $industry->name }}</a></option>
                                            @empty
